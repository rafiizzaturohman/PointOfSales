    ...
    $('#goods-table').DataTable({
        ...
        "columns": [
            ...
            { "data": "unit" },
            {
                "data": "picture",
                render: function (data) {
                    return `<img src="/images/upload/${data}" class="w-full"></img>`
                }
            },
            {
                "data": "barcode",
        ...
        "columns": [
            ...
            { "data": "phone" },
            {
                ...
                render: function (data) {
                    return `
                    <div class="flex space-x-2">
                        <a href="/customers/edit/${data}" class="transition bg-green-600 px-2 py-1 rounded-full hover:bg-green-500 text-white"><i class="fa-solid fa-circle-info"></i></a>
